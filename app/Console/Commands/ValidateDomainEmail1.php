...
class ValidateDomainEmail1 extends Command
{
     ...
     * @var string
     */
    protected $signature = 'validate:email1';
                        ...
                        foreach ($emails_array AS $email) {
                            ...
                            if($email_status = ""){
                                ...
                                if(isset($response_api_array['error']) && $response_api_array['error']['code'] == 104){
                                    DomainEmail::where('status', 'cron1')->orWhere('email',$email)->update(['status' => 'unverified']);
